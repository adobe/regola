 ...
 * Rules evaluator.
 */
public class Evaluator implements RulesEvaluator {

    @Override
    public EvaluationResult evaluate(Rule rule, FactsResolver factsResolver) {
        return rule.evaluate(factsResolver);
    }
}
