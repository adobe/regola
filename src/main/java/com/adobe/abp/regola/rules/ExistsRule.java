...
public class ExistsRule extends KeyBasedRule {
    ...
    public ExistsRule(String key) {
        this(null, key);
    }

    public ExistsRule(Executor executor) {
        super(RuleType.EXISTS.getName());
        this.executor = executor;
    }

    public ExistsRule(Executor executor, String key) {
        this(executor);
        setKey(key);
    }
        ...
        return new EvaluationResult() {
            ...
            public RuleResult snapshot() {
                return ValuesRuleResult.builder().with(r -> {
                    ...
                    r.result = result;
                    r.expectedValue = "<any>"; // This is a special expect value to indicate that any actual value is acceptable.
