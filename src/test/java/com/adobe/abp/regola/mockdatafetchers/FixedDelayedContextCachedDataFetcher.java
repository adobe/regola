 ...
 */
public class FixedDelayedContextCachedDataFetcher extends DataFetcher<Object, FixedDelayedContextCachedDataFetcher.RemoteContext> {

    private final int waitTime;

    public FixedDelayedContextCachedDataFetcher(int waitTime) {
